...
Build the `/editor` home screen and add project dialogs/sidebar actions. No API calls or
persistence yet.


## Editor Home

Reuse the existing editor layout. o not modify the navbar or sidebar  behavior.

In the center of the page, ad:

- heading: `Create a project or open an exisitng one`
